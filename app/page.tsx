...
const basePath = '/nekko-technologies-1775031846230';
...
export default function Home() {
  ...
  const submit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/01125325206?text=${msg}`, '_blank');
  };
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">Nekko Technologies</span>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              Number #1 Hosting, <span className="text-accent">IoT and communications company in Sarawak.</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              Nekko Technologies delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/01125325206`}
              target="_blank"
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">Conquering Sarawak Technology and Innovation Development</p>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Professional</h4>
                  <p className="text-sm text-on-surface-variant">Our commitment to integrity</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Technologies</h4>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">ryan@nekko-tech.cloud</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">01125325206</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">Nekko Technologies</div>
            <p className="text-white/60 text-sm leading-relaxed">Number #1 Hosting, IoT and communications company in Sarawak</p>
          </div>
          <div className="flex justify-center md:justify-center gap-6">
            
            
            <a href={`https://wa.me/01125325206`} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">WhatsApp</a>
          </div>
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              &copy; {new Date().getFullYear()} Nekko Technologies. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
